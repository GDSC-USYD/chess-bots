...
def db_update_player_data(player):
    pass


def db_update_matches_data(batch_id, matches_data):
...
def db_retrieve_players_data():
    #calls db and returns formatted player data
    temp = {"1":["neo", 9001, "https://drive.google.com/file/d/1vTnYdYU5tJOOYlWVG1ct9Lb9aTTYON1A/view?usp=sharing", 2], "2":["duece", 50, "https://drive.google.com/file/d/1vTnYdYU5tJOOYlWVG1ct9Lb9aTTYON1A/view?usp=sharing", 0] }
    player_data = temp
    return player_data
...
def main():
    ...
    #db_user, db_pass, db_host, db_name = get_db_credentials()
    #connect_to_db(db_user, db_pass, db_host, db_name)

    chessgamemaster = ChessGameMaster()
    chessgamemaster.run()
